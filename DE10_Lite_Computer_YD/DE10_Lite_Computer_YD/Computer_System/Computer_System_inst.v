	Computer_System u0 (
		...
		.servomoteur_external_connection_commande (<connected-to-servomoteur_external_connection_commande>), // servomoteur_external_connection.commande
		...
		.telemetre_external_connection_echo       (<connected-to-telemetre_external_connection_echo>),       //   telemetre_external_connection.echo
		.telemetre_external_connection_trig       (<connected-to-telemetre_external_connection_trig>),       //                                .trig
		.telemetre_external_connection_dist       (<connected-to-telemetre_external_connection_dist>),       //                                .dist
