...
#include "system.h" // Contient les adresses de base (BASE)
//#include "io.h"     // Contient les macros IORD et IOWR
#include "altera_avalon_pio_regs.h" // Pour les registres PIO standards
...
int main()
{
    ...
    while(1)
    {
        ...
        // On écrit la valeur vers les afficheurs (Adresse HEX3_HEX0_BASE dans system.h)
        IOWR(HEX3_HEX0_BASE, 0, affichage_hex);

        usleep(100000); // Attente de 100ms (100 000 microsecondes)
    }
